                ...
                function (e, t, r) {
                    ...
                    function c(e, t, r, n, i) {
                        ...
                        if (
                            ...
                            (a += N.writeDtlsParameters(e.dtlsTransport.getLocalParameters(), "offer" === r ? "actpass" : i || "active")),
                            (a += "a=mid:" + e.mid + "\r\n"),
                            ...
                            (a += "a=" + s),
                                ...
                                e.sendEncodingParameters[0].rtx &&
                                    ((a += "a=ssrc:" + e.sendEncodingParameters[0].rtx.ssrc + " " + s), (a += "a=ssrc-group:FID " + e.sendEncodingParameters[0].ssrc + " " + e.sendEncodingParameters[0].rtx.ssrc + "\r\n"));
                        }
                        return (
                                ...
                                for (var e = 0; e < p.codecs.length; e++) {
                                    ...
                                    if (r.name.toLowerCase() === t.name.toLowerCase() && r.clockRate === t.clockRate) {
                                        if (
                                            ...
                                            r.parameters &&
                                            t.parameters.apt &&
                                            ((n = r), (i = t), (a = d.codecs), (o = p.codecs), (c = s = void 0), (s = f(n.parameters.apt, a)), (c = f(i.parameters.apt, o)), !s || !c || s.name.toLowerCase() !== c.name.toLowerCase())
                                        )
                                            continue;
                                        ((t = JSON.parse(JSON.stringify(t))).numChannels = Math.min(r.numChannels, t.numChannels)),
                                            u.codecs.push(t),
                    ...
                    t.exports = function (I, L) {
                        ...
                        var n = function (e) {
                            ...
                            if (
                                        ...
                                        if (e && (e.urls || e.url)) {
                                            ...
                                            return (
                                                ...
                                                (t = t.filter(function (e) {
                                                    return 0 !== e.indexOf("turn:") || -1 === e.indexOf("transport=udp") || -1 !== e.indexOf("turn:[") || i
                                                        ? 0 === e.indexOf("stun:") && 14393 <= n && -1 === e.indexOf("?transport=udp")
                                                        : (i = !0);
                                                })),
                                                delete e.url,
                                                (e.urls = r ? t[0] : t),
                                ...
                                for (var o = e.iceCandidatePoolSize; 0 < o; o--) this._iceGatherers.push(new I.RTCIceGatherer({ iceServers: e.iceServers, gatherPolicy: e.iceTransportPolicy }));
                        ...
                        Object.defineProperty(n.prototype, "localDescription", {
                            ...
                            (n.prototype._createIceGatherer = function (r, e) {
                                ...
                                var i = new I.RTCIceGatherer({ iceServers: this._config.iceServers, gatherPolicy: this._config.iceTransportPolicy });
                                return (
                                    ...
                                    i.addEventListener("localcandidate", this.transceivers[r].bufferCandidates),
                                    i
                                );
                            }),
                            (n.prototype._gather = function (s, c) {
                                ...
                                if (!p.onlocalcandidate) {
                                    ...
                                    (this.transceivers[c].bufferedCandidateEvents = null),
                                        p.removeEventListener("localcandidate", this.transceivers[c].bufferCandidates),
                                        (p.onlocalcandidate = function (e) {
                                            if (!(d.usingBundle && 0 < c)) {
                                                ...
                                                if (n) ("new" !== p.state && "gathering" !== p.state) || (p.state = "completed");
                                                    ...
                                                    (t.candidate = Object.assign(t.candidate, N.parseCandidate(i))),
                                                        (t.candidate.candidate = i),
                                                        (t.candidate.toJSON = function () {
                                                            return { candidate: t.candidate.candidate, sdpMid: t.candidate.sdpMid, sdpMLineIndex: t.candidate.sdpMLineIndex, usernameFragment: t.candidate.usernameFragment };
                                                        });
                                                }
                                                ...
                                                "gathering" !== d.iceGatheringState && ((d.iceGatheringState = "gathering"), d._emitGatheringStateChange()),
                                                    ...
                                                    o && (d._dispatchEvent("icecandidate", new Event("icecandidate")), (d.iceGatheringState = "complete"), d._emitGatheringStateChange());
                                            }
                                        }),
                                        I.setTimeout(function () {
                            ...
                            (n.prototype._transceive = function (e, t, r) {
                                ...
                                t &&
                                    ...
                                    (n.rtcp = { cname: N.localCName, compound: e.rtcpParameters.compound }),
                            ...
                            (n.prototype.setLocalDescription = function (e) {
                                ...
                                return (f._localDescription = { type: e.type, sdp: e.sdp }), "offer" === e.type ? f._updateSignalingState("have-local-offer") : f._updateSignalingState("stable"), Promise.resolve();
                            }),
                                    ...
                                    e.forEach(function (e, t) {
                                        ...
                                        if (i || ("application" === n && ("DTLS/SCTP" === a || "UDP/DTLS/SCTP" === a))) w.transceivers[t] = { mid: c, kind: n, protocol: a, rejected: !0 };
                                            ...
                                            var S = N.parseRtcpParameters(e),
                                                R = 0 < N.matchPrefix(e, "a=end-of-candidates", D).length,
                                                P = N.matchPrefix(e, "a=candidate:")
                                                    .map(function (e) {
                                            ...
                                            if (
                                                ...
                                                if ("answer" === k.type && !i) {
                                                    (p = (d = w.transceivers[t]).iceGatherer),
                                                        ...
                                                        (h = d.localCapabilities),
                                                        (w.transceivers[t].recvEncodingParameters = v),
                                                        (w.transceivers[t].remoteCapabilities = T),
                                                        (w.transceivers[t].rtcpParameters = S),
                                                        P.length &&
                                                            "new" === u.state &&
                                                            ((!O && !R) || (M && 0 !== t)
                                                                ...
                                                                : u.setRemoteCandidates(P)),
                                                        (M && 0 !== t) || ("new" === u.state && u.start(p, y, "controlling"), "new" === f.state && f.start(C)),
                                                        !A(d.localCapabilities, d.remoteCapabilities).codecs.filter(function (e) {
                                                            return "rtx" === e.name.toLowerCase();
                                                        }).length &&
                                                            d.sendEncodingParameters[0].rtx &&
                                                            delete d.sendEncodingParameters[0].rtx,
                                                        w._transceive(d, "sendrecv" === o || "recvonly" === o, "sendrecv" === o || "sendonly" === o),
                                                        !l || ("sendrecv" !== o && "sendonly" !== o)
                                                            ? delete d.rtpReceiver
                                                            : ((g = l.track),
                                                              s
                                                                  ? (_[s.stream] || (_[s.stream] = new I.MediaStream()), j(g, _[s.stream]), x.push([g, l, _[s.stream]]))
                                                                  : (_.default || (_.default = new I.MediaStream()), j(g, _.default), x.push([g, l, _.default])));
                                                }
                                            } else {
                                                ((d = w.transceivers[t] || w._createTransceiver(n)).mid = c),
                                                    d.iceGatherer || (d.iceGatherer = w._createIceGatherer(t, M)),
                                                    P.length &&
                                                        ...
                                                        (!R || (M && 0 !== t)
                                                            ...
                                                            : d.iceTransport.setRemoteCandidates(P)),
                                                    (h = I.RTCRtpReceiver.getCapabilities(n)),
                                                    L < 15019 &&
                                                        (h.codecs = h.codecs.filter(function (e) {
                                                            return "rtx" !== e.name;
                                                        })),
                                                ...
                                                if ("sendrecv" === o || "sendonly" === o) {
                                                    if (((b = !d.rtpReceiver), (l = d.rtpReceiver || new I.RTCRtpReceiver(d.dtlsTransport, n)), b))
                                                        (g = l.track),
                                                            (s && "-" === s.stream) ||
                                                                (s
                                                                    ? (_[s.stream] ||
                                                                          ((_[s.stream] = new I.MediaStream()),
                                                                          Object.defineProperty(_[s.stream], "id", {
                                                                              get: function () {
                                                                                  return s.stream;
                                                                              },
                                                                          })),
                                                                      ...
                                                                      (E = _[s.stream]))
                                                                    : (_.default || (_.default = new I.MediaStream()), (E = _.default))),
                                                            E && (j(g, E), d.associatedRemoteMediaStreams.push(E)),
                                                            x.push([g, l, E]);
                                                } else
                                                    d.rtpReceiver &&
                                                        d.rtpReceiver.track &&
                                                        (d.associatedRemoteMediaStreams.forEach(function (e) {
                                                            var t,
                                                                r,
                                                ...
                                                (d.localCapabilities = h),
                                                    (d.remoteCapabilities = T),
                                                    (d.rtpReceiver = l),
                                                    (d.rtcpParameters = S),
                                                    (d.sendEncodingParameters = m),
                                                    (d.recvEncodingParameters = v),
                                                    w._transceive(w.transceivers[t], !1, b);
                                            }
                                        }
                                    }),
                                    void 0 === w._dtlsRole && (w._dtlsRole = "offer" === k.type ? "active" : "passive"),
                                    (w._remoteDescription = { type: k.type, sdp: k.sdp }),
                                    "offer" === k.type ? w._updateSignalingState("have-remote-offer") : w._updateSignalingState("stable"),
                            ...
                            (n.prototype.createOffer = function () {
                                ...
                                for (
                                    ...
                                    0 < t && (s._createTransceiver("audio"), t--), 0 < r && (s._createTransceiver("video"), r--);
                                ...
                                s.transceivers.forEach(function (e, t) {
                                    ...
                                    r && 15019 <= L && "video" === n && !o[0].rtx && (o[0].rtx = { ssrc: o[0].ssrc + 1 }),
                            ...
                            (n.prototype.createAnswer = function () {
                                ...
                                i.transceivers.forEach(function (e, t) {
                                    if (!(o < t + 1)) {
                                        ...
                                        var r;
                                        if (e.stream)
                                            "audio" === e.kind ? (r = e.stream.getAudioTracks()[0]) : "video" === e.kind && (r = e.stream.getVideoTracks()[0]),
                                                r && 15019 <= L && "video" === e.kind && !e.sendEncodingParameters[0].rtx && (e.sendEncodingParameters[0].rtx = { ssrc: e.sendEncodingParameters[0].ssrc + 1 });
                                        var n = A(e.localCapabilities, e.remoteCapabilities);
                                    ...
                                    : new Promise(function (e, t) {
                                          ...
                                          if (c && "" !== c.candidate) {
                                              ...
                                              0 === o.indexOf("a=") && (o = o.substr(2)),
                                                  ((d = N.getMediaSections(p._remoteDescription.sdp))[r] += "a=" + (a.type ? o : "end-of-candidates") + "\r\n"),
                                    ...
                                    return r.apply(this).then(function (r) {
                                        ...
                                        return (
                                            Object.keys(r).forEach(function (e) {
                                                var t;
                                                (r[e].type =
                                                    { inboundrtp: "inbound-rtp", outboundrtp: "outbound-rtp", candidatepair: "candidate-pair", localcandidate: "local-candidate", remotecandidate: "remote-candidate" }[(t = r[e]).type] ||
                                                    t.type),
                                                    n.set(e, r[e]);
                                            }),
                                            n
                ...
                function (e, t, r) {
                    ...
                    (p.localCName = p.generateIdentifier()),
                        ...
                        (p.getIceParameters = function (e, t) {
                            ...
                            return {
                                usernameFragment: (r = r.concat(p.splitLines(t)))
                                    .filter(function (e) {
                        ...
                        (p.parseRtpParameters = function (e) {
                            for (var t = { codecs: [], headerExtensions: [], fecMechanisms: [], rtcp: [] }, r = p.splitLines(e)[0].split(" "), n = 3; n < r.length; n++) {
                                var i = r[n],
                        ...
                        (p.parseRtpEncodingParameters = function (e) {
                            ...
                            0 < c.length && 1 < c[0].length && c[0][0] === s && (r = c[0][1]),
                                t.codecs.forEach(function (e) {
                                    if ("RTX" === e.name.toUpperCase() && e.parameters.apt) {
                                        ...
                                        s && r && (t.rtx = { ssrc: r }), n.push(t), i && (((t = JSON.parse(JSON.stringify(t))).fec = { ssrc: s, mechanism: a ? "red+ulpfec" : "red" }), n.push(t));
                                    }
                                }),
                            ...
                            return (
                                d.length &&
                                    ((d = 0 === d[0].indexOf("b=TIAS:") ? parseInt(d[0].substr(7), 10) : 0 === d[0].indexOf("b=AS:") ? 1e3 * parseInt(d[0].substr(5), 10) * 0.95 - 16e3 : void 0),
                        ...
                        (p.writeMediaSection = function (e, t, r, n) {
                            ...
                            if (
                                ((i += p.writeIceParameters(e.iceGatherer.getLocalParameters())),
                                (i += p.writeDtlsParameters(e.dtlsTransport.getLocalParameters(), "offer" === r ? "actpass" : "active")),
                                (i += "a=mid:" + e.mid + "\r\n"),
                                e.direction
                                    ? (i += "a=" + e.direction + "\r\n")
                                ...
                                (i += "a=" + a),
                                    ...
                                    e.sendEncodingParameters[0].rtx &&
                                        ((i += "a=ssrc:" + e.sendEncodingParameters[0].rtx.ssrc + " " + a), (i += "a=ssrc-group:FID " + e.sendEncodingParameters[0].ssrc + " " + e.sendEncodingParameters[0].rtx.ssrc + "\r\n"));
                            }
                            return (
            ...
            4: [
                function (l, e, t) {
                    ...
                    e.exports = function (e, t) {
                        var r = e && e.window,
                            n = { shimChrome: !0, shimFirefox: !0, shimEdge: !0, shimSafari: !0 };
                        ...
                        var a = m.log,
                            ...
                            f = { browserDetails: o, commonShim: u, extractVersion: m.extractVersion, disableLog: m.disableLog, disableWarnings: m.disableWarnings };
                        switch (o.browser) {
                            case "chrome":
                                ...
                                a("adapter.js shimming chrome."),
                                    (f.browserShim = s),
                                    u.shimCreateObjectURL(r),
                                    s.shimGetUserMedia(r),
                                    s.shimMediaStream(r),
                                    s.shimSourceObject(r),
                                    s.shimPeerConnection(r),
                                    s.shimOnTrack(r),
                                    s.shimAddTrackRemoveTrack(r),
                                    s.shimGetSendersWithDtmf(r),
                                    s.shimSenderReceiverGetStats(r),
                                    s.fixNegotiationNeeded(r),
                                    u.shimRTCIceCandidate(r),
                                    u.shimMaxMessageSize(r),
                                    u.shimSendThrowTypeError(r);
                                break;
                            case "firefox":
                                ...
                                a("adapter.js shimming firefox."),
                                    ...
                                    d.shimSenderGetStats(r),
                                    d.shimReceiverGetStats(r),
                                    d.shimRTCDataChannel(r),
                                    u.shimRTCIceCandidate(r),
                                    u.shimMaxMessageSize(r),
                                    u.shimSendThrowTypeError(r);
                                break;
                    ...
                    t.exports = {
                                ...
                                a.RTCPeerConnection.prototype.setRemoteDescription = function () {
                                    ...
                                    return (
                                        i._ontrackpoly ||
                                            ...
                                            i.addEventListener("addstream", i._ontrackpoly)),
                                        e.apply(i, arguments)
                                    );
                                };
                            }
                                ...
                                (!e.HTMLMediaElement ||
                                    ...
                                    Object.defineProperty(e.HTMLMediaElement.prototype, "srcObject", {
                                        ...
                                        set: function (e) {
                                            var t = this;
                                            (this._srcObject = e),
                                                this.src && r.revokeObjectURL(this.src),
                                                e
                                                    ? ((this.src = r.createObjectURL(e)),
                                ...
                                ["createOffer", "createAnswer"].forEach(function (e) {
                                    ...
                                    o.RTCPeerConnection.prototype[e] = function () {
                                        ...
                                        return arguments.length && "function" == typeof arguments[0]
                                            ...
                                            : t.apply(r, arguments).then(function (e) {
                                                  return a(r, e);
                                              });
                                    };
                                });
                        ...
                        shimPeerConnection: function (r) {
                            ...
                            !r.RTCPeerConnection &&
                                ...
                                (r.RTCPeerConnection.prototype = r.webkitRTCPeerConnection.prototype),
                                r.webkitRTCPeerConnection.generateCertificate &&
                                    Object.defineProperty(r.RTCPeerConnection, "generateCertificate", {
                                        get: function () {
                                ...
                                var a = function (e) {
                                        ...
                                        return (
                                            e.result().forEach(function (t) {
                                                var r = { id: t.id, timestamp: t.timestamp, type: { localcandidate: "local-candidate", remotecandidate: "remote-candidate" }[t.type] || t.type };
                        ...
                        shimGetDisplayMedia: function (e, r) {
                            "getDisplayMedia" in e.navigator ||
                                ("function" == typeof r
                                    ? (navigator.getDisplayMedia = function (t) {
                                          return r(t).then(function (e) {
                                              return (t.video = { mandatory: { chromeMediaSource: "desktop", chromeMediaSourceId: e, maxFrameRate: t.video.frameRate || 3 } }), navigator.mediaDevices.getUserMedia(t);
                                          });
                                      })
            ...
            6: [
                function (e, t, r) {
                    ...
                    t.exports = function (e) {
                                    ...
                                    Object.keys(i).forEach(function (t) {
                                        if ("require" !== t && "advanced" !== t && "mediaSource" !== t) {
                                            ...
                                            void 0 !== r.exact && "number" != typeof r.exact
                                                ? ((a.mandatory = a.mandatory || {}), (a.mandatory[n("", t)] = r.exact))
                                                : ["min", "max"].forEach(function (e) {
                                                      void 0 !== r[e] && ((a.mandatory = a.mandatory || {}), (a.mandatory[n(e, t)] = r[e]));
                                                  });
                                        }
                                    }),
                                    i.advanced && (a.optional = (a.optional || []).concat(i.advanced)),
                                    a
                                );
                            },
                            n = function (r, n) {
                                ...
                                if (r && "object" == typeof r.video) {
                                    ...
                                    if (
                                        i &&
                                        ("user" === i.exact || "environment" === i.exact || "user" === i.ideal || "environment" === i.ideal) &&
                                        (!s.mediaDevices.getSupportedConstraints || !s.mediaDevices.getSupportedConstraints().facingMode || t)
                                    )
                                        if ((delete r.video.facingMode, "environment" === i.exact || "environment" === i.ideal ? (a = ["back", "rear"]) : ("user" !== i.exact && "user" !== i.ideal) || (a = ["front"]), a))
                                            return s.mediaDevices.enumerateDevices().then(function (e) {
                                                ...
                                                return (
                                                    !t && e.length && -1 !== a.indexOf("back") && (t = e[e.length - 1]),
                                                    t && (r.video.deviceId = i.exact ? { exact: t.deviceId } : { ideal: t.deviceId }),
                                                    (r.video = c(r.video)),
                        ...
                        void 0 === s.mediaDevices.addEventListener &&
                            (s.mediaDevices.addEventListener = function () {
                                d("Dummy mediaDevices.addEventListener called.");
                            }),
                            void 0 === s.mediaDevices.removeEventListener &&
                                (s.mediaDevices.removeEventListener = function () {
                            ...
                            if (t.RTCIceCandidate && !(t.RTCIceCandidate && "foundation" in t.RTCIceCandidate.prototype)) {
                                ...
                                (t.RTCIceCandidate = function (e) {
                                    if (("object" == typeof e && e.candidate && 0 === e.candidate.indexOf("a=") && ((e = JSON.parse(JSON.stringify(e))).candidate = e.candidate.substr(2)), e.candidate && e.candidate.length)) {
                                        ...
                                        return (
                                            (n.toJSON = function () {
                                                return { candidate: n.candidate, sdpMid: n.sdpMid, sdpMLineIndex: n.sdpMLineIndex, usernameFragment: n.usernameFragment };
                                            }),
                                            n
                                        );
                                    }
                                    ...
                                    c.wrapPeerConnectionEvent(t, "icecandidate", function (e) {
                    ...
                    t.exports = {
                        ...
                        shimPeerConnection: function (s) {
                            ...
                            if ("object" == typeof s && (s.RTCPeerConnection || s.mozRTCPeerConnection)) {
                                s.RTCPeerConnection ||
                                    ((s.RTCPeerConnection = function (e, t) {
                                    ...
                                    s.mozRTCPeerConnection.generateCertificate &&
                                        Object.defineProperty(s.RTCPeerConnection, "generateCertificate", {
                                            get: function () {
                                ...
                                var a = { inboundrtp: "inbound-rtp", outboundrtp: "outbound-rtp", candidatepair: "candidate-pair", localcandidate: "local-candidate", remotecandidate: "remote-candidate" },
                ...
                function (e, t, r) {
                    ...
                    t.exports = function (e) {
                        var i = f.detectBrowser(e),
                            ...
                            o = function (e) {
                                return {
                                    name: { InternalError: "NotReadableError", NotSupportedError: "TypeError", PermissionDeniedError: "NotAllowedError", SecurityError: "NotAllowedError" }[e.name] || e.name,
                                    ...
                                    return (
                                        Object.keys(n).forEach(function (e) {
                                            if ("require" !== e && "advanced" !== e && "mediaSource" !== e) {
                                                ...
                                                if (
                                                    ((void 0 === t.min && void 0 === t.max && void 0 === t.exact) || i.push(e),
                                                    void 0 !== t.exact && ("number" == typeof t.exact ? (t.min = t.max = t.exact) : (n[e] = t.exact), delete t.exact),
                                                    void 0 !== t.ideal)
                                                ) {
                                                    n.advanced = n.advanced || [];
                                                    var r = {};
                                                    "number" == typeof t.ideal ? (r[e] = { min: t.ideal, max: t.ideal }) : (r[e] = t.ideal), n.advanced.push(r), delete t.ideal, Object.keys(t).length || delete n[e];
                                                }
                                            }
                                        }),
                                        i.length && (n.require = i),
                                        n
                                    );
                                };
                                return (
                                    (e = JSON.parse(JSON.stringify(e))),
                                    i.version < 38 && (l("spec: " + JSON.stringify(e)), e.audio && (e.audio = n(e.audio)), e.video && (e.video = n(e.video)), l("ff37: " + JSON.stringify(e))),
                                    a.mozGetUserMedia(e, t, function (e) {
                                        r(o(e));
                                    })
                                );
                            };
                        ...
                        if (!(55 < i.version && "autoGainControl" in a.mediaDevices.getSupportedConstraints())) {
                            ...
                            if (
                                ((a.mediaDevices.getUserMedia = function (e) {
                                    return (
                                        "object" == typeof e && "object" == typeof e.audio && ((e = JSON.parse(JSON.stringify(e))), c(e.audio, "autoGainControl", "mozAutoGainControl"), c(e.audio, "noiseSuppression", "mozNoiseSuppression")),
                                        d(e)
                                    );
                                }),
                            ...
                            if (t && t.prototype.applyConstraints) {
                                ...
                                t.prototype.applyConstraints = function (e) {
                                    return (
                                        "audio" === this.kind && "object" == typeof e && ((e = JSON.parse(JSON.stringify(e))), c(e, "autoGainControl", "mozAutoGainControl"), c(e, "noiseSuppression", "mozNoiseSuppression")),
                                        u.apply(this, [e])
                                    );
                                };
                            }
                            ...
                            if ("object" == typeof e && e.RTCPeerConnection) {
                                if (
                                    ...
                                    "getStreamById" in e.RTCPeerConnection.prototype ||
                                        (e.RTCPeerConnection.prototype.getStreamById = function (t) {
                                            var r = null;
                                            return (
                                                this._localStreams &&
                                                    this._localStreams.forEach(function (e) {
                                                        e.id === t && (r = e);
                                                    }),
                                                this._remoteStreams &&
                        ...
                        shimGetUserMedia: function (e) {
                            ...
                            n.getUserMedia ||
                                (n.webkitGetUserMedia
                                    ? (n.getUserMedia = n.webkitGetUserMedia.bind(n))
                                    : n.mediaDevices &&
                                ...
                                if (e && e.iceServers) {
                                    for (var r = [], n = 0; n < e.iceServers.length; n++) {
                                        ...
                                        !i.hasOwnProperty("urls") && i.hasOwnProperty("url")
                                            ? (o.deprecated("RTCIceServer.url", "RTCIceServer.urls"), ((i = JSON.parse(JSON.stringify(i))).urls = i.url), delete i.url, r.push(i))
                            ...
                            e.RTCPeerConnection.prototype.createOffer = function (e) {
                                ...
                                if (e) {
                                    ...
                                    !1 === e.offerToReceiveAudio && r
                                        ...
                                        : !0 !== e.offerToReceiveAudio || r || t.addTransceiver("audio"),
                                    ...
                                    !1 === e.offerToReceiveVideo && n
                                        ...
                                        : !0 !== e.offerToReceiveVideo || n || t.addTransceiver("video");
                                }
