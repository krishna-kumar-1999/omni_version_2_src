...
@Component({
  selector: 'app-predictive-activity',
  templateUrl: './predictive-activity.component.html',
  styleUrls: ['./predictive-activity.component.css']
})
export class PredictiveActivityComponent implements OnInit {
  contact_id;
  addnotes: FormGroup;
  oldNotes;
  uadmin_id;
  ...
  getNotes(){
    ...
    conct_req.user_id=2;
    conct_req.action="get_predictive_notes";
    conct_req.unique_id='swderftg';
    conct_req.phone_no = this.phone_num;
    conct_req.call_id=localStorage.getItem("predict_callid");
...
//       this.router.navigate(['/predictive-dialer-calls']);
...
//           this.router.navigate(['/predictive-dialer-calls'], { queryParams: { phone:  decodedString,cont_id:cont_id} });
//         }
//       }, 
//       (error)=>{
//           console.log(error);
